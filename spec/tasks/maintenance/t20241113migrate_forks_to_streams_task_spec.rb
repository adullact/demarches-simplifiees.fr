...
module Maintenance
  RSpec.describe T20241113migrateForksToStreamsTask do
    FactoryBot.define do
      factory :migration_dossier, class: Maintenance::T20241113migrateForksToStreamsTask::Dossier, parent: :dossier do
      end
    end
    ...
    describe "#process" do
      ...
      let(:dossier) { create(:migration_dossier, :with_populated_champs, procedure:) }
